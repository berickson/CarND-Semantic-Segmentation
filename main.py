...
def load_vgg(sess, vgg_path):
    print("loading saved model from ", vgg_path)
    """
    ...
    input_tensor = vgg.get_tensor_by_name(vgg_input_tensor_name)
    keep_prob_tensor = vgg.get_tensor_by_name(vgg_keep_prob_tensor_name)
    layer3_out_tensor = vgg.get_tensor_by_name(vgg_layer3_out_tensor_name)
    layer4_out_tensor = vgg.get_tensor_by_name(vgg_layer4_out_tensor_name)
    layer7_out_tensor = vgg.get_tensor_by_name(vgg_layer7_out_tensor_name)
